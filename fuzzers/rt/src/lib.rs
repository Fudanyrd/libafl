...
//! The example harness is built for freetype2.
...
#[derive(Debug, Parser)]
#[command(
    name = "libfuzzer_freetype",
    about = "A libfuzzer-like fuzzer for freetype2 with llmp-multithreading support and a launcher",
