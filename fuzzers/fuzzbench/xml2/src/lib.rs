...
//! The example harness is built for libxml.
...
use libafl::{
    ...
    schedulers::{IndexesLenTimeMinimizerScheduler, QueueScheduler, SetcoverScheduler},
...
#[derive(Debug, Parser)]
#[command(
    name = "libfuzzer_libxml_launcher",
    about = "A libfuzzer-like fuzzer for libxml with llmp-multithreading support and a launcher",
